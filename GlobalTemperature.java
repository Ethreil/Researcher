...
public class GlobalTemperature {
	...
	{
		double CO2In1959 = CarbonDioxide.getAvgPPM(1959);
		double CO2In1960 = CarbonDioxide.getAvgPPM(1960);
		double CO2In1961 = CarbonDioxide.getAvgPPM(1961);
		
		double tempIndexIn1959 = getLandOceanTemperatureIndex(1959);
		double tempIndexIn1960 = getLandOceanTemperatureIndex(1960);
		double tempIndexIn1961 = getLandOceanTemperatureIndex(1961);
		...
		return ( ( ((tempIndexCurrentMinus2 + tempIndexCurrentMinus3 + tempIndexCurrentMinus4) / 3.0) 
				- ((tempIndexIn1959 + tempIndexIn1960 + tempIndexIn1961) / 3.0) ) 
				/ ( ((CO2CurrentMinus2 + CO2CurrentMinus3 + CO2CurrentMinus4) / 3.0)
				- ((CO2In1959 + CO2In1960 + CO2In1961) / 3.0)) );
	}
	...
	public static void generateJSONFilePastValues () throws MalformedURLException, JSONException, IOException
	{
		...
		File file = new File("pastGlobalTempData.json");
		file.createNewFile();
	...
	public static void generateJSONFileCurrentValue () throws MalformedURLException, JSONException, IOException
	{
		...
		File file = new File("currentGlobalTempData.json");
		file.createNewFile();
		FileWriter fileWriter = new FileWriter(file);
	...
	public static void generateJSONFileFutureValues () throws MalformedURLException, IOException, JSONException
	{
		...
		File file = new File("futureGlobalTempData.json");
		file.createNewFile();
		FileWriter fileWriter = new FileWriter(file);
